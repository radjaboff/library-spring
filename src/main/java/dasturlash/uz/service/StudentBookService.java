...
public class StudentBookService {
    ...
    public void booksOnHandByStudentId() {
        List<StudentBook> studentBookList = studentBookRepository.studentBookOnHand(componentContainer.getCurrentProfile().getId(), StudentBookStatus.TAKEN);
    ...
    public void returnBook(Integer bId) {
        Integer sId = componentContainer.getCurrentProfile().getId();
...
//        }
    ...
    public void takenBookHistory() {
        List<StudentBook> studentBookList =studentBookRepository.studentBookOnHand(componentContainer.getCurrentProfile().getId(), null);
        for (StudentBook st : studentBookList) {
            String title = st.getBook().getTitle();
            String author = st.getBook().getAuthor();
